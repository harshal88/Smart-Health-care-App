...
public class UserPrefActivity extends Activity {
    ...
    public final static int PREF_RUNFREQ = 7;
...
//        }
       ...
       // String frequency = ""+((SeekBar)findViewById(R.id.SeekCycleFreq)).getProgress();
        
      
        
        TextView freq = (TextView) findViewById(R.id.TextFreq);
        String frequency = freq.getText().toString();
        
        String home_zip = ((EditText)findViewById(R.id.TextZipHome)).getText().toString();
        String work_zip = ((EditText)findViewById(R.id.TextZipWork)).getText().toString();
        String school_zip = ((EditText)findViewById(R.id.TextZipSchool)).getText().toString();
        String email = ((EditText)findViewById(R.id.TextEmail)).getText().toString();
        
        Log.w("Age", Age);
        Log.w("frequency", frequency);
        Log.w("home_zip", home_zip);
        Log.w("work_zip", work_zip);
        Log.w("school_zip", school_zip);
        Log.w("email", email);
        Log.w("gender", gender);
        
     //   loginDataBaseAdapter.updatepref(age, gender, frequency, home_zip, work_zip, school_zip, email, "hj");
        
        
        
		Toast.makeText(getBaseContext(),"User preferences saved.", Toast.LENGTH_SHORT).show();
		
//		Intent homescreen = new Intent (UserPrefActivity.this,HomeActivity.class);
